...
rp_module_desc="Macintosh emulator - SDL2 version"
...
function sources_basilisk-sdl2() {
    gitPullOrClone "$md_build" https://github.com/kanjitalk755/macemu.git
}
...
function configure_basilisk-sdl2() {
    ...
    addEmulator 0 "$md_id" "macintosh" "$md_inst/bin/BasiliskII --rom $romdir/macintosh/mac.rom --disk $romdir/macintosh/disk.img --extfs $romdir/macintosh --config $md_conf_root/macintosh/basiliskii-sdl2.cfg ${params[*]}"
    addSystem "macintosh"
}
