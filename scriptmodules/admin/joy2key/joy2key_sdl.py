...
def main():
    ...
    if 'SDL_JoystickGetVendor' not in dir(joystick):
        LOG.debug(f'Function "SDL_JoystickGetVendor" not found in PySDL2, adding a local definition for it')
    ...
    if 'SDL_JoystickGetProduct' not in dir(joystick):
        LOG.debug(f'Function "SDL_JoystickGetProduct" not found in PySDL2, adding a local definition for it')
